...
%\VignetteEngine{knitr::Sweave2knitr}
...
\date{Modified: 12 November, 2014. Compiled: \today}
...
If you have installed \Rfunction{rjags}, you can create the rank gene list with
the following command.

<<chunk-rank, eval=FALSE>>=
rank<-degRank(g1,g2,counts[detag10,],fc,400,500)
degPR(rank)
@

Remember to change the number of iteration for the bayes approximation to 1000
or 5000.\Rfunction{rank<-degRank(g1,g2,counts[detag10,],fc,400,5000)}

You can paralellize the score calculation with \textbf{BiocParallel}:

<<chunk-8, eval=FALSE>>=
rank<-degRank(g1,g2,counts[detag10,],fc,400,2000,ncores=4)
@
