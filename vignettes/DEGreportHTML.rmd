...
Run the following lines if you want to visualize your expression values by 
condition
...
You can use individual functions, like degRank or degMean. This will 
create specific figures and tables showed in the report. 
